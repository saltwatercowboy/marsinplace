...
const placeData = {
    ...
    literature: [
...

        {
            ...
            fictionalYear: '~2040',
            realYear: 1992,
            description: "In Red Mars, Acheron was where a series of longevity treatments were developed, functionally extending the human lifespan by hundreds of years. This gerontoligical treatment (and its lack of widespread availability) is responsible for much of the political turmoil, war, and civic unrest that unfolds throughout the Mars Trilogy.",
    ...
    filmAndTV: [
        ...
        
        {
            ...
            fictionalYear: '2059',
            realYear: 2009,
            description: "In the Doctor Who episode The Waters of Mars, Bowie Base One is the first human colony on Mars. The colonists encounter an 'intelligent virus' that targets any organism with water in its body. The Doctor leads a timely intervention.",
            region: 'Gusev Crater',
