...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Hn,depthTest:!1,depthWrite:!1})}function Iu(){return new ln({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Bl(),fragmentShader:`
		...
		`,blending:Hn,depthTest:!1,depthWrite:!1})}function Uu(){return new ln({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Bl(),fragmentShader:`
...
`);let s=[];for(let a=0,l=i.length;a<l;a++){const c=i[a].trimStart();if(c.length===0)continue;const u=c.charAt(0);if(u!=="#")if(u==="v"){const h=c.split(ph);switch(h[0]){case"v":t.vertices.push(parseFloat(h[1]),parseFloat(h[2]),parseFloat(h[3])),h.length>=7?(Qr.setRGB(parseFloat(h[4]),parseFloat(h[5]),parseFloat(h[6])).convertSRGBToLinear(),t.colors.push(Qr.r,Qr.g,Qr.b)):t.colors.push(void 0,void 0,void 0);break;case"vn":t.normals.push(parseFloat(h[1]),parseFloat(h[2]),parseFloat(h[3]));break;case"vt":t.uvs.push(parseFloat(h[1]),parseFloat(h[2]));break}}else if(u==="f"){const d=c.slice(1).trim().split(ph),m=[];for(let x=0,p=d.length;x<p;x++){const f=d[x];if(f.length>0){const S=f.split("/");m.push(S)}}const _=m[0];for(let x=1,p=m.length-1;x<p;x++){const f=m[x],S=m[x+1];t.addFace(_[0],f[0],S[0],_[1],f[1],S[1],_[2],f[2],S[2])}}else if(u==="l"){const h=c.substring(1).trim().split(" ");let d=[];const m=[];if(c.indexOf("/")===-1)d=h;else for(let _=0,x=h.length;_<x;_++){const p=h[_].split("/");p[0]!==""&&d.push(p[0]),p[1]!==""&&m.push(p[1])}t.addLineGeometry(d,m)}else if(u==="p"){const d=c.slice(1).trim().split(" ");t.addPointGeometry(d)}else if((s=Uy.exec(c))!==null){const h=(" "+s[0].slice(1).trim()).slice(1);t.startObject(h)}else if(Fy.test(c))t.object.startMaterial(c.substring(7).trim(),t.materialLibraries);else if(Ny.test(c))t.materialLibraries.push(c.substring(7).trim());else if(Oy.test(c))console.warn('THREE.OBJLoader: Rendering identifier "usemap" not supported. Textures must be defined in MTL files.');else if(u==="s"){if(s=c.split(" "),s.length>1){const d=s[1].trim().toLowerCase();t.object.smooth=d!=="0"&&d!=="off"}else t.object.smooth=!0;const h=t.object.currentMaterial();h&&(h.smooth=t.object.smooth)}else{if(c==="\0")continue;console.warn('THREE.OBJLoader: Unexpected line: "'+c+'"')}}t.finalize();const r=new Ws;if(r.materialLibraries=[].concat(t.materialLibraries),!(t.objects.length===1&&t.objects[0].geometry.vertices.length===0)===!0)for(let a=0,l=t.objects.length;a<l;a++){const c=t.objects[a],u=c.geometry,h=c.materials,d=u.type==="Line",m=u.type==="Points";let _=!1;if(u.vertices.length===0)continue;const x=new At;x.setAttribute("position",new at(u.vertices,3)),u.normals.length>0&&x.setAttribute("normal",new at(u.normals,3)),u.colors.length>0&&(_=!0,x.setAttribute("color",new at(u.colors,3))),u.hasUVIndices===!0&&x.setAttribute("uv",new at(u.uvs,2));const p=[];for(let S=0,M=h.length;S<M;S++){const w=h[S],F=w.name+"_"+w.smooth+"_"+_;let A=t.materials[F];if(this.materials!==null){if(A=this.materials.create(w.name),d&&A&&!(A instanceof Ms)){const R=new Ms;wn.prototype.copy.call(R,A),R.color.copy(A.color),A=R}else if(m&&A&&!(A instanceof Xs)){const R=new Xs({size:10,sizeAttenuation:!1});wn.prototype.copy.call(R,A),R.color.copy(A.color),R.map=A.map,A=R}}A===void 0&&(d?A=new Ms:m?A=new Xs({size:1,sizeAttenuation:!1}):A=new oi,A.name=w.name,A.flatShading=!w.smooth,A.vertexColors=_,t.materials[F]=A),p.push(A)}let f;if(p.length>1){for(let S=0,M=h.length;S<M;S++){const w=h[S];x.addGroup(w.groupStart,w.groupCount,S)}d?f=new ih(x,p):m?f=new La(x,p):f=new bt(x,p)}else d?f=new ih(x,p[0]):m?f=new La(x,p[0]):f=new bt(x,p[0]);f.name=c.name,r.add(f)}else if(t.vertices.length>0){const a=new Xs({size:1,sizeAttenuation:!1}),l=new At;l.setAttribute("position",new at(t.vertices,3)),t.colors.length>0&&t.colors[0]!==void 0&&(l.setAttribute("color",new at(t.colors,3)),a.vertexColors=!0);const c=new La(l,a);r.add(c)}return r}}function zy(){const n=new rf;return new Promise((e,t)=>{n.load("models/g_phobos_287m.obj",i=>{e(i)},i=>{console.log(i.loaded/i.total*100+"% loaded")},i=>{t(new Error("An error happened during loading of the model."))})})}function Hy(){const n=new rf;return new Promise((e,t)=>{n.load("models/g_deimos_162m.obj",i=>{e(i)},i=>{console.log(i.loaded/i.total*100+"% loaded")},i=>{t(new Error("An error happened during loading of the model."))})})}async function ky(){try{let m=function(_){const x=new Float32Array(_.length*3);for(let S=0;S<_.length;S++)x[S*3]=_[S].x,x[S*3+1]=_[S].y,x[S*3+2]=_[S].z;const p=new At;return p.setAttribute("position",new an(x,3)),new zl(p,d)};var n=m;const e=await zy(),t=await Hy();e.name="moon",t.name="moon",e.receiveShadow=!0,e.color="white",e.traverse(function(_){_.isMesh&&(_.receiveShadow=!0)});const i=400,s=1200;let r=2*Math.PI/2500,o=2*Math.PI/5e3,a=0,l=400;const c=[],u=[],h=499,d=new Ms({color:16777215});return e.tick=_=>{a-=r,l-=o,e.position.x=i*Math.cos(a),e.position.z=i*Math.sin(a),t.position.x=s*Math.cos(l),t.position.z=s*Math.sin(l),c.push(e.position.clone()),u.push(t.position.clone()),c.length>h&&c.shift(),u.length>h&&u.shift();const x=_.getObjectByName("phobosTrail"),p=_.getObjectByName("deimosTrail");x&&(_.remove(x),x.geometry.dispose(),x.material.dispose()),p&&(_.remove(p),p.geometry.dispose(),p.material.dispose());const f=m(c);f.name="phobosTrail",_.add(f);const S=m(u);S.name="deimosTrail",_.add(S)},[e,t]}catch(e){console.error(e)}}const Mn="/marsisaplace",Vy={literature:[{id:2,body:"Mars",placeName:"Underhill",media:"The Mars Trilogy",creator:"Kim Stanley Robinson",fictionalYear:2026,realYear:1992,description:"Underhill was the landing site for the first hundred colonists in Kim Stanley Robinson’s Red Mars. Built 10m underground as a shield from the radiation piercing Mars’ sparse magnetosphere, the burrow featured a vaulted brick ceiling, bamboo flooring, and intricate staircases composed of a novel magnesium alloy extracted from the Martian regolith.",region:"Xanthe",photoFile:Mn+"/modal/placeholder.png",lat:8.05,lon:-43.9,jewelColor:"green"},{id:3,body:"Mars",placeName:"Home of Valentine M. Smith",media:"Stranger in a Strange Land",creator:"Robert A. Heinlein",fictionalYear:"Late 20th Century",realYear:1961,description:"Smith's real areographical origin isn't described exactly at any point in the novel, but Elysium Mons seems fitting given Heinlein's vision of an idyllic Martian society. Valentine, a human raised by Martians, is a super-genius with psychic powers. When he returns to Earth, he uses his abilities to found and promote a lifestyle based on peace, free love, and the promotion of vices such as gambling. The Church of All Worlds, a real-life paganistic religion, was later founded on Valentine's principles.",region:"Elysium Mons",photoFile:Mn+"/modal/siasl.png",lat:24.5,lon:122.1,jewelColor:"green"},{id:5,body:"Mars",placeName:"Handramit",media:"Out of the Silent Planet",creator:"C.S. Lewis",fictionalYear:"Unknown",realYear:1938,description:"Handramit are river valleys surrounded by staggering mountains (handrada) and inhabited by the hrossa, an otter-like, sapient species. C.S. Lewis saw celestial order as an extension of theological natural law. In his Space Trilogy, Mars is known as Malacandra (the Land of Mars), and Earth as Thulcandra (the Silent Planet). Each is guarded by an angel (Oyarsa), though Earth's became bitter and twisted by rebellion.",region:"Valles Marineris",photoFile:Mn+"/modal/ootsp.png",lat:-8.75,lon:-16.8,jewelColor:"green"},{id:6,body:"Mars",placeName:"Burroughs",media:"The Mars Trilogy",creator:"Kim Stanley Robinson",fictionalYear:"~2040",realYear:1992,description:"Burroughs was the largest city, political center, and de facto capital of Mars throughout much of Kim Stanley Robinson's Mars Trilogy. In Green Mars, it was flooded by a revolutionary group of radicals known as the kakaze ('fire wind') by demolishing a key dike. By the events of Blue Mars, it had become a popular diving spot.",region:"Isidis Planitia",photoFile:Mn+"/modal/burroughs.png",lat:12.9,lon:190,jewelColor:"green"},{id:7,body:"Mars",placeName:"Sheffield",media:"The Mars Trilogy",creator:"Kim Stanley Robinson",fictionalYear:"2047",realYear:1992,description:"Sheffield, built into the caldera of Pavonis Mons, was the mooring point for both the first (destroyed) and second space elevators. A boom town throughout the trilogy, waxing and waning with the fate of the elevators, a 'socket' at the center of the city anchors a ~35,000km long cable that descends from a counterweight asteroid known as Clarke.",region:"Pavonis Mons",photoFile:Mn+"/modal/sheffield.png",lat:1.48,lon:23,jewelColor:"green"},{id:8,body:"Mars",placeName:"Senzeni Na (Mohole)",media:"The Mars Trilogy",creator:"Kim Stanley Robinson",fictionalYear:"2047",realYear:1992,description:"Senzeni Na, meaning 'what have we done' in Zulu, is one of many 'moholes' that terraforming advocates ('Greens') bored deep into the crust of Mars. Their primary opponent was the 'Red' faction, who advocated for a more primordial, untouched, and dead Mars for scientific, aesthetic, and moral reasons. Over time, moholes warmed Mars by pulling respectable amounts of heat energy from deep underground into the atmosphere.",region:"Thaumasia Planum",photoFile:Mn+"/modal/senzenina.png",lat:-16,lon:-24,jewelColor:"green"},{id:9,body:"Mars",placeName:"Acheron",media:"The Mars Trilogy",creator:"Kim Stanley Robinson",fictionalYear:"~2040",realYear:1992,description:"In Red Mars, Acheron was where a series of longevity treatments were developed. These could extend the human lifespan by hundreds of years and were a key motivator of political turmoil, war, and civic unrest throughout the Mars Trilogy due to their expense and exclusivity.",region:"Arcadia Planitia",photoFile:Mn+"/modal/acheron.png",lat:40,lon:84,jewelColor:"green"},{id:10,body:"Mars",placeName:"Greater Helium",media:"A Princess of Mars",creator:"Edgar Rice Burroughs",fictionalYear:"1865",realYear:1912,description:"Burrough's Mars was known as 'Barsoom', a dying world fought over by shifting hegemonic alliances of city-states. The city of Greater Helium (and Lesser Helium, a little sister 75 miles away) became the hero John Carter's home and seat after he married the Princess of Helium.",region:"Hesperia Planium",photoFile:Mn+"/modal/ghelium.png",lat:-28,lon:165,jewelColor:"green"}],filmAndTV:[{id:1,body:"Mars",placeName:"The Hab",media:"The Martian",creator:"Andy Weir",fictionalYear:2035,realYear:2011,description:"The site where botanist Mark Watney spent most of his 561 sols (1 year, 6 months, 27 days in Earth time). Weir's novel took an optimistic view of near-future human space travel, where NASA had successfully mounted three manned missions to Mars by 2035.",region:"Acidalia Planitia",photoFile:Mn+"/modal/thehab.png",lat:36.12,lon:27.5-90,jewelColor:"white"},{id:4,body:"Mars",placeName:"Bowie Base One",media:"Doctor Who",creator:"Russell T. Davies & Phil Ford",fictionalYear:"2059",realYear:2009,description:"In the Doctor Who episode The Waters of Mars, Bowie Base One is the first human colony on Mars. The colonists encounter an 'intelligent virus' that targeted any organism with water in its body. The Doctor leads a timely intervention.",region:"Gusev Crater",photoFile:Mn+"/modal/bb1.png",lat:5.5,lon:176,jewelColor:"white"}],reality:[]},vh={placeData:Vy};class Gy extends bt{constructor(e){super(),this.data=e;const t=Math.tan(Math.PI/6),i=Math.cos(Math.PI/6),s=[2,1,2,1,3,0,3,2,0,2,4,1,1,4,3,3,4,2],r=[0,1,0,1,0,t,-1,0,t,0,0,-i,0,-1,0];this.jewelGeometry=new Fo(r,s,1.6,0),this.jewelMaterial=new dr({fog:!0,wireframe:!1,color:e.jewelColor,reflectivity:20}),this.jewelMesh=new bt(this.jewelGeometry,this.jewelMaterial),this.jewelActive=!1,this.jewelSize=0,this.jewelMesh.name="rotationMesh",this.jewelMesh.tick=o=>{}}}class xh{constructor(e,t,i,s){this.placeType=e,this.dataList=t,this.celestialBody=s,this.isActive=i,this.path="/src/World/assets/places/photos/"}createAll(){this.setActive(),this.assignPlaceData(),this.placeData.forEach(this.findPosition),this.placeData.forEach(this.createPins)}getType(){return this.placeType}getPinsData(){return this.placeData}setActive(e){this.isActive=e}assignPlaceData(){if(this.dataList.placeData[this.placeType])this.placeData=this.dataList.placeData[this.placeType];else throw new Error(`Type "${this.placeType}" not in placeData`)}findPosition(e){switch(e.body){case"Mars":var t=200,i=(90-e.lat)*Math.PI/180,s=(180+e.lon)*Math.PI/180;Object.defineProperties(e,{x:{value:t*Math.sin(i)*Math.cos(s),writable:!0},y:{value:t*Math.cos(i),writable:!0},z:{value:t*Math.sin(i)*Math.sin(s),writable:!0}})}}createPins(e){const t=new U(e.x,e.y,e.z),i=t.clone().normalize(),s=20,r=1,o=t.clone().add(i.multiplyScalar(s)),a=t.clone().add(i.multiplyScalar(r)),l=[];l.push(t),l.push(o);const c=new At().setFromPoints(l),u=new Ms({color:"#7FFFFF"}),h=new zl(c,u),d=Math.tan(Math.PI/6),m=Math.cos(Math.PI/6),_=[0,1,0,1,0,d,-1,0,d,0,0,-m,0,-1,0],x=[2,1,2,1,3,0,3,2,0,2,4,1,1,4,3,3,4,2],p=new Fo(_,x,2,0),f=new dr({wireframe:!0,color:"#7FFFFF"}),S=new bt(p,f);S.position.copy(a),S.lookAt(new U(0,0,0)),Object.defineProperty(S,"data",{value:e});const M=new Gy(e).jewelMesh;M.position.copy(a),M.lookAt(new U(0,0,0)),Object.defineProperty(e,"mesh",{value:h}),Object.defineProperty(e,"diamondMesh",{value:S}),Object.defineProperty(e,"jewelMesh",{value:M})}}function Wy(){const n=new py({antialias:!0,logarithmicDepthBuffer:!0,toneMapping:Pl});return n.shadowMap.enabled=!0,n.shadowMap.type=bd,n}const Mh=(n,e,t,i)=>{e.aspect=n.clientWidth/n.clientHeight,e.updateProjectionMatrix(),t.setSize(n.clientWidth,n.clientHeight),t.setPixelRatio(window.devicePixelRatio)};class Xy{constructor(e,t,i,s){Mh(e,t,i),window.addEventListener("resize",()=>{Mh(e,t,i)})}}const jy=new sf;class Yy{constructor(e,t,i,s){this.camera=e,this.scene=t,this.renderer=i,this.composer=s,this.updatables=[]}start(){this.renderer.setAnimationLoop(()=>{this.renderer.render(this.scene,this.camera),this.composer.render(),this.tick()})}stop(){this.renderer.render(null)}tick(){const e=jy.getDelta();for(const t of this.updatables)t.tick(e)}}const yh={type:"change"},Ua={type:"start"},Sh={type:"end"},Jr=new hr,Eh=new ri,qy=Math.cos(70*o_.DEG2RAD);class Ky extends Gi{constructor(e,t){super(),this.object=e,this.domElement=t,this.domElement.style.touchAction="none",this.enabled=!0,this.target=new U,this.cursor=new U,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:Wi.ROTATE,MIDDLE:Wi.DOLLY,RIGHT:Wi.PAN},this.touches={ONE:Xi.ROTATE,TWO:Xi.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this.getPolarAngle=function(){return a.phi},this.getAzimuthalAngle=function(){return a.theta},this.getDistance=function(){return this.object.position.distanceTo(this.target)},this.listenToKeyEvents=function(v){v.addEventListener("keydown",le),this._domElementKeyEvents=v},this.stopListenToKeyEvents=function(){this._domElementKeyEvents.removeEventListener("keydown",le),this._domElementKeyEvents=null},this.saveState=function(){i.target0.copy(i.target),i.position0.copy(i.object.position),i.zoom0=i.object.zoom},this.reset=function(){i.target.copy(i.target0),i.object.position.copy(i.position0),i.object.zoom=i.zoom0,i.object.updateProjectionMatrix(),i.dispatchEvent(yh),i.update(),r=s.NONE},this.update=function(){const v=new U,J=new Vi().setFromUnitVectors(e.up,new U(0,1,0)),W=J.clone().invert(),ee=new U,ue=new Vi,Ce=new U,ze=2*Math.PI;return function(ft=null){const $e=i.object.position;v.copy($e).sub(i.target),v.applyQuaternion(J),a.setFromVector3(v),i.autoRotate&&r===s.NONE&&O(y(ft)),i.enableDamping?(a.theta+=l.theta*i.dampingFactor,a.phi+=l.phi*i.dampingFactor):(a.theta+=l.theta,a.phi+=l.phi);let pt=i.minAzimuthAngle,mt=i.maxAzimuthAngle;isFinite(pt)&&isFinite(mt)&&(pt<-Math.PI?pt+=ze:pt>Math.PI&&(pt-=ze),mt<-Math.PI?mt+=ze:mt>Math.PI&&(mt-=ze),pt<=mt?a.theta=Math.max(pt,Math.min(mt,a.theta)):a.theta=a.theta>(pt+mt)/2?Math.max(pt,a.theta):Math.min(mt,a.theta)),a.phi=Math.max(i.minPolarAngle,Math.min(i.maxPolarAngle,a.phi)),a.makeSafe(),i.enableDamping===!0?i.target.addScaledVector(u,i.dampingFactor):i.target.add(u),i.target.sub(i.cursor),i.target.clampLength(i.minTargetRadius,i.maxTargetRadius),i.target.add(i.cursor);let Gt=!1;if(i.zoomToCursor&&A||i.object.isOrthographicCamera)a.radius=ye(a.radius);else{const Wt=a.radius;a.radius=ye(a.radius*c),Gt=Wt!=a.radius}if(v.setFromSpherical(a),v.applyQuaternion(W),$e.copy(i.target).add(v),i.object.lookAt(i.target),i.enableDamping===!0?(l.theta*=1-i.dampingFactor,l.phi*=1-i.dampingFactor,u.multiplyScalar(1-i.dampingFactor)):(l.set(0,0,0),u.set(0,0,0)),i.zoomToCursor&&A){let Wt=null;if(i.object.isPerspectiveCamera){const Wn=v.length();Wt=ye(Wn*c);const vi=Wn-Wt;i.object.position.addScaledVector(w,vi),i.object.updateMatrixWorld(),Gt=!!vi}else if(i.object.isOrthographicCamera){const Wn=new U(F.x,F.y,0);Wn.unproject(i.object);const vi=i.object.zoom;i.object.zoom=Math.max(i.minZoom,Math.min(i.maxZoom,i.object.zoom/c)),i.object.updateProjectionMatrix(),Gt=vi!==i.object.zoom;const xi=new U(F.x,F.y,0);xi.unproject(i.object),i.object.position.sub(xi).add(Wn),i.object.updateMatrixWorld(),Wt=v.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),i.zoomToCursor=!1;Wt!==null&&(this.screenSpacePanning?i.target.set(0,0,-1).transformDirection(i.object.matrix).multiplyScalar(Wt).add(i.object.position):(Jr.origin.copy(i.object.position),Jr.direction.set(0,0,-1).transformDirection(i.object.matrix),Math.abs(i.object.up.dot(Jr.direction))<qy?e.lookAt(i.target):(Eh.setFromNormalAndCoplanarPoint(i.object.up,i.target),Jr.intersectPlane(Eh,i.target))))}else if(i.object.isOrthographicCamera){const Wt=i.object.zoom;i.object.zoom=Math.max(i.minZoom,Math.min(i.maxZoom,i.object.zoom/c)),Wt!==i.object.zoom&&(i.object.updateProjectionMatrix(),Gt=!0)}return c=1,A=!1,Gt||ee.distanceToSquared(i.object.position)>o||8*(1-ue.dot(i.object.quaternion))>o||Ce.distanceToSquared(i.target)>o?(i.dispatchEvent(yh),ee.copy(i.object.position),ue.copy(i.object.quaternion),Ce.copy(i.target),!0):!1}}(),this.dispose=function(){i.domElement.removeEventListener("contextmenu",Me),i.domElement.removeEventListener("pointerdown",he),i.domElement.removeEventListener("pointercancel",g),i.domElement.removeEventListener("wheel",j),i.domElement.removeEventListener("pointermove",b),i.domElement.removeEventListener("pointerup",g),i.domElement.getRootNode().removeEventListener("keydown",ce,{capture:!0}),i._domElementKeyEvents!==null&&(i._domElementKeyEvents.removeEventListener("keydown",le),i._domElementKeyEvents=null)};const i=this,s={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6};let r=s.NONE;const o=1e-6,a=new fh,l=new fh;let c=1;const u=new U,h=new we,d=new we,m=new we,_=new we,x=new we,p=new we,f=new we,S=new we,M=new we,w=new U,F=new we;let A=!1;const R=[],N={};let E=!1;function y(v){return v!==null?2*Math.PI/60*i.autoRotateSpeed*v:2*Math.PI/60/60*i.autoRotateSpeed}function L(v){const J=Math.abs(v*.01);return Math.pow(.95,i.zoomSpeed*J)}function O(v){l.theta-=v}function G(v){l.phi-=v}const ie=function(){const v=new U;return function(W,ee){v.setFromMatrixColumn(ee,0),v.multiplyScalar(-W),u.add(v)}}(),re=function(){const v=new U;return function(W,ee){i.screenSpacePanning===!0?v.setFromMatrixColumn(ee,1):(v.setFromMatrixColumn(ee,0),v.crossVectors(i.object.up,v)),v.multiplyScalar(W),u.add(v)}}(),Q=function(){const v=new U;return function(W,ee){const ue=i.domElement;if(i.object.isPerspectiveCamera){const Ce=i.object.position;v.copy(Ce).sub(i.target);let ze=v.length();ze*=Math.tan(i.object.fov/2*Math.PI/180),ie(2*W*ze/ue.clientHeight,i.object.matrix),re(2*ee*ze/ue.clientHeight,i.object.matrix)}else i.object.isOrthographicCamera?(ie(W*(i.object.right-i.object.left)/i.object.zoom/ue.clientWidth,i.object.matrix),re(ee*(i.object.top-i.object.bottom)/i.object.zoom/ue.clientHeight,i.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),i.enablePan=!1)}}();function ne(v){i.object.isPerspectiveCamera||i.object.isOrthographicCamera?c/=v:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),i.enableZoom=!1)}function Y(v){i.object.isPerspectiveCamera||i.object.isOrthographicCamera?c*=v:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),i.enableZoom=!1)}function ge(v,J){if(!i.zoomToCursor)return;A=!0;const W=i.domElement.getBoundingClientRect(),ee=v-W.left,ue=J-W.top,Ce=W.width,ze=W.height;F.x=ee/Ce*2-1,F.y=-(ue/ze)*2+1,w.set(F.x,F.y,1).unproject(i.object).sub(i.object.position).normalize()}function ye(v){return Math.max(i.minDistance,Math.min(i.maxDistance,v))}function Se(v){h.set(v.clientX,v.clientY)}function De(v){ge(v.clientX,v.clientX),f.set(v.clientX,v.clientY)}function Ye(v){_.set(v.clientX,v.clientY)}function se(v){d.set(v.clientX,v.clientY),m.subVectors(d,h).multiplyScalar(i.rotateSpeed);const J=i.domElement;O(2*Math.PI*m.x/J.clientHeight),G(2*Math.PI*m.y/J.clientHeight),h.copy(d),i.update()}function de(v){S.set(v.clientX,v.clientY),M.subVectors(S,f),M.y>0?ne(L(M.y)):M.y<0&&Y(L(M.y)),f.copy(S),i.update()}function ve(v){x.set(v.clientX,v.clientY),p.subVectors(x,_).multiplyScalar(i.panSpeed),Q(p.x,p.y),_.copy(x),i.update()}function pe(v){ge(v.clientX,v.clientY),v.deltaY<0?Y(L(v.deltaY)):v.deltaY>0&&ne(L(v.deltaY)),i.update()}function He(v){let J=!1;switch(v.code){case i.keys.UP:v.ctrlKey||v.metaKey||v.shiftKey?G(2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):Q(0,i.keyPanSpeed),J=!0;break;case i.keys.BOTTOM:v.ctrlKey||v.metaKey||v.shiftKey?G(-2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):Q(0,-i.keyPanSpeed),J=!0;break;case i.keys.LEFT:v.ctrlKey||v.metaKey||v.shiftKey?O(2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):Q(i.keyPanSpeed,0),J=!0;break;case i.keys.RIGHT:v.ctrlKey||v.metaKey||v.shiftKey?O(-2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):Q(-i.keyPanSpeed,0),J=!0;break}J&&(v.preventDefault(),i.update())}function Ne(v){if(R.length===1)h.set(v.pageX,v.pageY);else{const J=Ae(v),W=.5*(v.pageX+J.x),ee=.5*(v.pageY+J.y);h.set(W,ee)}}function ke(v){if(R.length===1)_.set(v.pageX,v.pageY);else{const J=Ae(v),W=.5*(v.pageX+J.x),ee=.5*(v.pageY+J.y);_.set(W,ee)}}function I(v){const J=Ae(v),W=v.pageX-J.x,ee=v.pageY-J.y,ue=Math.sqrt(W*W+ee*ee);f.set(0,ue)}function We(v){i.enableZoom&&I(v),i.enablePan&&ke(v)}function C(v){i.enableZoom&&I(v),i.enableRotate&&Ne(v)}function D(v){if(R.length==1)d.set(v.pageX,v.pageY);else{const W=Ae(v),ee=.5*(v.pageX+W.x),ue=.5*(v.pageY+W.y);d.set(ee,ue)}m.subVectors(d,h).multiplyScalar(i.rotateSpeed);const J=i.domElement;O(2*Math.PI*m.x/J.clientHeight),G(2*Math.PI*m.y/J.clientHeight),h.copy(d)}function H(v){if(R.length===1)x.set(v.pageX,v.pageY);else{const J=Ae(v),W=.5*(v.pageX+J.x),ee=.5*(v.pageY+J.y);x.set(W,ee)}p.subVectors(x,_).multiplyScalar(i.panSpeed),Q(p.x,p.y),_.copy(x)}function Z(v){const J=Ae(v),W=v.pageX-J.x,ee=v.pageY-J.y,ue=Math.sqrt(W*W+ee*ee);S.set(0,ue),M.set(0,Math.pow(S.y/f.y,i.zoomSpeed)),ne(M.y),f.copy(S);const Ce=(v.pageX+J.x)*.5,ze=(v.pageY+J.y)*.5;ge(Ce,ze)}function $(v){i.enableZoom&&Z(v),i.enablePan&&H(v)}function te(v){i.enableZoom&&Z(v),i.enableRotate&&D(v)}function he(v){i.enabled!==!1&&(R.length===0&&(i.domElement.setPointerCapture(v.pointerId),i.domElement.addEventListener("pointermove",b),i.domElement.addEventListener("pointerup",g)),!me(v)&&(Fe(v),v.pointerType==="touch"?xe(v):P(v)))}function b(v){i.enabled!==!1&&(v.pointerType==="touch"?ae(v):k(v))}function g(v){switch(Pe(v),R.length){case 0:i.domElement.releasePointerCapture(v.pointerId),i.domElement.removeEventListener("pointermove",b),i.domElement.removeEventListener("pointerup",g),i.dispatchEvent(Sh),r=s.NONE;break;case 1:const J=R[0],W=N[J];xe({pointerId:J,pageX:W.x,pageY:W.y});break}}function P(v){let J;switch(v.button){case 0:J=i.mouseButtons.LEFT;break;case 1:J=i.mouseButtons.MIDDLE;break;case 2:J=i.mouseButtons.RIGHT;break;default:J=-1}switch(J){case Wi.DOLLY:if(i.enableZoom===!1)return;De(v),r=s.DOLLY;break;case Wi.ROTATE:if(v.ctrlKey||v.metaKey||v.shiftKey){if(i.enablePan===!1)return;Ye(v),r=s.PAN}else{if(i.enableRotate===!1)return;Se(v),r=s.ROTATE}break;case Wi.PAN:if(v.ctrlKey||v.metaKey||v.shiftKey){if(i.enableRotate===!1)return;Se(v),r=s.ROTATE}else{if(i.enablePan===!1)return;Ye(v),r=s.PAN}break;default:r=s.NONE}r!==s.NONE&&i.dispatchEvent(Ua)}function k(v){switch(r){case s.ROTATE:if(i.enableRotate===!1)return;se(v);break;case s.DOLLY:if(i.enableZoom===!1)return;de(v);break;case s.PAN:if(i.enablePan===!1)return;ve(v);break}}function j(v){i.enabled===!1||i.enableZoom===!1||r!==s.NONE||(v.preventDefault(),i.dispatchEvent(Ua),pe(X(v)),i.dispatchEvent(Sh))}function X(v){const J=v.deltaMode,W={clientX:v.clientX,clientY:v.clientY,deltaY:v.deltaY};switch(J){case 1:W.deltaY*=16;break;case 2:W.deltaY*=100;break}return v.ctrlKey&&!E&&(W.deltaY*=10),W}function ce(v){v.key==="Control"&&(E=!0,i.domElement.getRootNode().addEventListener("keyup",oe,{passive:!0,capture:!0}))}function oe(v){v.key==="Control"&&(E=!1,i.domElement.getRootNode().removeEventListener("keyup",oe,{passive:!0,capture:!0}))}function le(v){i.enabled===!1||i.enablePan===!1||He(v)}function xe(v){switch(Oe(v),R.length){case 1:switch(i.touches.ONE){case Xi.ROTATE:if(i.enableRotate===!1)return;Ne(v),r=s.TOUCH_ROTATE;break;case Xi.PAN:if(i.enablePan===!1)return;ke(v),r=s.TOUCH_PAN;break;default:r=s.NONE}break;case 2:switch(i.touches.TWO){case Xi.DOLLY_PAN:if(i.enableZoom===!1&&i.enablePan===!1)return;We(v),r=s.TOUCH_DOLLY_PAN;break;case Xi.DOLLY_ROTATE:if(i.enableZoom===!1&&i.enableRotate===!1)return;C(v),r=s.TOUCH_DOLLY_ROTATE;break;default:r=s.NONE}break;default:r=s.NONE}r!==s.NONE&&i.dispatchEvent(Ua)}function ae(v){switch(Oe(v),r){case s.TOUCH_ROTATE:if(i.enableRotate===!1)return;D(v),i.update();break;case s.TOUCH_PAN:if(i.enablePan===!1)return;H(v),i.update();break;case s.TOUCH_DOLLY_PAN:if(i.enableZoom===!1&&i.enablePan===!1)return;$(v),i.update();break;case s.TOUCH_DOLLY_ROTATE:if(i.enableZoom===!1&&i.enableRotate===!1)return;te(v),i.update();break;default:r=s.NONE}}function Me(v){i.enabled!==!1&&v.preventDefault()}function Fe(v){R.push(v.pointerId)}function Pe(v){delete N[v.pointerId];for(let J=0;J<R.length;J++)if(R[J]==v.pointerId){R.splice(J,1);return}}function me(v){for(let J=0;J<R.length;J++)if(R[J]==v.pointerId)return!0;return!1}function Oe(v){let J=N[v.pointerId];J===void 0&&(J=new we,N[v.pointerId]=J),J.set(v.pageX,v.pageY)}function Ae(v){const J=v.pointerId===R[0]?R[1]:R[0];return N[J]}i.domElement.addEventListener("contextmenu",Me),i.domElement.addEventListener("pointerdown",he),i.domElement.addEventListener("pointercancel",g),i.domElement.addEventListener("wheel",j,{passive:!1}),i.domElement.getRootNode().addEventListener("keydown",ce,{passive:!0,capture:!0}),this.update()}}function $y(n,e){const t=new Ky(n,e);return t.enableDamping=!0,t.minDistance=430,t.maxDistance=2600,t}const of={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`};class sS extends fr{constructor(){super();const e=iS;this.uniforms=Uo.clone(e.uniforms),this.material=new _y({name:e.name,uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader}),this.fsQuad=new kl(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,i){this.uniforms.tDiffuse.value=i.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},Qe.getTransfer(this._outputColorSpace)===it&&(this.material.defines.SRGB_TRANSFER=""),this._toneMapping===Td?this.material.defines.LINEAR_TONE_MAPPING="":this._toneMapping===wd?this.material.defines.REINHARD_TONE_MAPPING="":this._toneMapping===Ad?this.material.defines.CINEON_TONE_MAPPING="":this._toneMapping===Pl?this.material.defines.ACES_FILMIC_TONE_MAPPING="":this._toneMapping===Cd?this.material.defines.AGX_TONE_MAPPING="":this._toneMapping===Rd&&(this.material.defines.NEUTRAL_TONE_MAPPING=""),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this.fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this.fsQuad.render(e))}dispose(){this.material.dispose(),this.fsQuad.dispose()}}class rS extends fr{constructor(e,t,i,s){super(),this.scene=e,this.camera=t,this.sampleLevel=4,this.unbiased=!0,this.clearColor=i!==void 0?i:0,this.clearAlpha=s!==void 0?s:0,this._oldClearColor=new je;const r=of;this.copyUniforms=Uo.clone(r.uniforms),this.copyMaterial=new ln({uniforms:this.copyUniforms,vertexShader:r.vertexShader,fragmentShader:r.fragmentShader,transparent:!0,depthTest:!1,depthWrite:!1,premultipliedAlpha:!0,blending:Ka}),this.fsQuad=new kl(this.copyMaterial)}dispose(){this.sampleRenderTarget&&(this.sampleRenderTarget.dispose(),this.sampleRenderTarget=null),this.copyMaterial.dispose(),this.fsQuad.dispose()}setSize(e,t){this.sampleRenderTarget&&this.sampleRenderTarget.setSize(e,t)}render(e,t,i){this.sampleRenderTarget||(this.sampleRenderTarget=new Vn(i.width,i.height,{type:Rs}),this.sampleRenderTarget.texture.name="SSAARenderPass.sample");const s=oS[Math.max(0,Math.min(this.sampleLevel,5))],r=e.autoClear;e.autoClear=!1,e.getClearColor(this._oldClearColor);const o=e.getClearAlpha(),a=1/s.length,l=1/32;this.copyUniforms.tDiffuse.value=this.sampleRenderTarget.texture;const c={fullWidth:i.width,fullHeight:i.height,offsetX:0,offsetY:0,width:i.width,height:i.height},u=Object.assign({},this.camera.view);u.enabled&&Object.assign(c,u);for(let h=0;h<s.length;h++){const d=s[h];this.camera.setViewOffset&&this.camera.setViewOffset(c.fullWidth,c.fullHeight,c.offsetX+d[0]*.0625,c.offsetY+d[1]*.0625,c.width,c.height);let m=a;if(this.unbiased){const _=-.5+(h+.5)/s.length;m+=l*_}this.copyUniforms.opacity.value=m,e.setClearColor(this.clearColor,this.clearAlpha),e.setRenderTarget(this.sampleRenderTarget),e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(this.renderToScreen?null:t),h===0&&(e.setClearColor(0,0),e.clear()),this.fsQuad.render(e)}this.camera.setViewOffset&&u.enabled?this.camera.setViewOffset(u.fullWidth,u.fullHeight,u.offsetX,u.offsetY,u.width,u.height):this.camera.clearViewOffset&&this.camera.clearViewOffset(),e.autoClear=r,e.setClearColor(this._oldClearColor,o)}}const oS=[[[0,0]],[[4,4],[-4,-4]],[[-2,-6],[6,-2],[-6,2],[2,6]],[[1,-3],[-1,3],[5,1],[-3,-5],[-5,5],[-7,-1],[3,7],[7,-7]],[[1,1],[-1,-3],[-3,2],[4,-1],[-5,-2],[2,5],[5,3],[3,-5],[-2,6],[0,-7],[-4,-6],[-6,4],[-8,0],[7,-4],[6,7],[-7,-8]],[[-4,-7],[-7,-5],[-3,-5],[-5,-4],[-1,-4],[-2,-2],[-6,-1],[-4,0],[-7,1],[-1,2],[-6,3],[-3,3],[-7,6],[-3,6],[-5,7],[-1,7],[5,-7],[1,-6],[6,-5],[4,-4],[2,-3],[7,-2],[1,-1],[4,-1],[2,1],[6,2],[0,4],[4,4],[2,5],[7,5],[5,6],[3,7]]];let fs;class aS{constructor(e){this.events={},this.showOverlay=!1,this.camera=Ay(e),this.focusCamera=Cy(e),this.placeholderImg=new er().load("/marsisaplace/modal/placeholder.png"),this.siasl=new er().load("/marsisaplace/modal/siasl.png"),this.background=Dy(),this.raycaster=new wy,this.mouse=new we,this.hoveredObject=null,this.mars=Ly(),this.overlay=Py(),this.mars.loadingComplete=!1,this.renderer=Wy(),e.append(this.renderer.domElement),this.background.add(this.mars,this.overlay);const{mainLight:t,softenerLightLower:i,ambientLight:s,overlayLight:r}=Iy();this.mainLight=t,this.background.add(t,i,s,r),$y(this.camera,e),new Xy(e,this.camera,this.renderer,this.composer),this.composer=new nS(this.renderer),this.composer.setPixelRatio(1),this.ssaaPass=new rS(this.background,this.camera),this.outputPass=new sS,fs=new Yy(this.camera,this.background,this.renderer,this.composer),fs.updatables.push(this.mars,this.overlay),fs.updatables.push({tick:()=>this.focusCamera.tick(this.background)}),this.createAllMarkers(),console.log("mars name",this.mars.children),this.loadAddMoons(),this.loadingText=null,e.addEventListener("mousemove",this.onMouseMove.bind(this),!1),e.addEventListener("click",this.onClick.bind(this),!1),this.handleOverlay()}async loadAddMoons(){try{const[e,t]=await ky();this.phobos=e,this.background.add(this.phobos),this.background.add(t),fs.updatables.push({tick:()=>e.tick(this.background)}),this.mars.loadingComplete=!0,this.emit("loadingDone",{message:"Loading done."}),console.log("Moons loaded")}catch(e){console.error("Error loading moons:",e)}}start(){fs.start()}stop(){fs.stop()}on(e,t){this.events[e]||(this.events[e]=[]),this.events[e].push(t)}off(e,t){this.events[e]&&(this.events[e]=this.events[e].filter(i=>i!==t))}emit(e,t){this.events[e]&&this.events[e].forEach(i=>i(t))}handleLoadingState(){this.emit("loading",{message:"Loading assets..."})}handleOverlay(){this.showOverlay==!0?(this.overlay.scale.set(0,0,0),this.showOverlay=!1):this.showOverlay==!1&&(this.overlay.scale.set(1,1,1),this.showOverlay=!0)}createAllMarkers(){var e=new xh("literature",vh,!0,"Mars");e.createAll();let t=e.getPinsData();var i=new xh("filmAndTV",vh,!0,"Mars");i.createAll();let s=i.getPinsData();for(let r=0;r<t.length;r++)this.mars.add(t[r].mesh),this.mars.add(t[r].diamondMesh),this.mars.add(t[r].jewelMesh),this.createLabel(t[r].diamondMesh);for(let r=0;r<s.length;r++)this.mars.add(s[r].mesh),this.mars.add(s[r].diamondMesh),this.mars.add(s[r].jewelMesh),this.createLabel(s[r].diamondMesh);this.mars.geometry.computeBoundingBox()}createLabel(e){const t=document.createElement("canvas"),i=t.getContext("2d");t.width=300,t.height=50,i.fillStyle="rgba(255, 255, 255, 0)",i.fillRect(0,0,t.width,t.height),i.fillStyle="#FFFFFF",i.font="bold 18px Andale Mono",i.textAlign="center",i.textBaseline="middle",i.fillText(e.data.placeName,t.width/2,25);const s=new oh(t),r=new As(50,10),o=new dr({map:s,transparent:!0,side:nn});let a=new bt(r,o);a.position.y=a.position.y+5;var l=new U;console.log("tst",e.getWorldPosition(l)),a.isLabel=!0,e.add(a),a.rotation.y=Math.PI}createModals(e){this.modal&&(this.background.remove(this.modal),this.modal.geometry.dispose(),this.modal.material.map.dispose(),this.modal.material.dispose(),this.background.remove(this.imgModal),this.imgModal.geometry.dispose(),this.imgModal.material.map.dispose(),this.imgModal.material.dispose());const t=document.createElement("canvas"),i=t.getContext("2d");t.width=300,t.height=500,i.fillStyle="rgba(127, 255, 255, 0.1)",i.fillRect(0,0,t.width,t.height),i.strokeStyle="#00FFFF",i.lineWidth=2,i.strokeRect(0,0,t.width,t.height),i.fillStyle="#FFFFFF",i.font="bold 20px Arial",i.textAlign="center",i.textBaseline="middle",i.fillText(e.placeName,t.width/2,25),i.font="bold 16px Arial",i.textAlign="left",i.textBaseline="top",i.shadowColor="rgba(0, 0, 0, 0)";const s=[`Media: ${e.media}`,`Creator: ${e.creator}`,`Year Set: ${e.fictionalYear}`,`Year Published: ${e.realYear}`,`Region: ${e.region}`],r=e.description;s.forEach((p,f)=>{i.fillText(p,20,60+f*25)}),i.fillStyle="#CCCCCC",i.font="italic 16px Univers",i.textAlign="left",i.textBaseline="top";const o=t.width-40,a=20;let l=20,c=60+s.length*25+10;const u=r.split(" ");let h="";for(let p=0;p<u.length;p++){const f=h+u[p]+" ";i.measureText(f).width>o&&p>0?(i.fillText(h,l,c),h=u[p]+" ",c+=a):h=f}i.fillText(h,l,c),new As(45,85);const d=new oh(t),m=new sl({map:d,transparent:!0,side:nn});var _=new er().load(e.photoFile),x=new sl({map:_,color:16777215});this.imgModal=new Qu(x),this.imgModal.isModal=!0,this.modal=new Qu(m),this.modal.scale.set(50,100,1),this.modal.isModal=!0,this.background.add(this.modal),this.background.add(this.imgModal)}onMouseMove(e){e.preventDefault();const t=e.target.getBoundingClientRect();this.mouse.x=(e.clientX-t.left)/t.width*2-1,this.mouse.y=-((e.clientY-t.top)/t.height)*2+1,this.raycaster.setFromCamera(this.mouse,this.camera);const i=this.raycaster.intersectObjects(this.background.children,!0);if(i.length>0){const s=i[0].object;if(s.isModal||s.isLabel||s.isOverlay)return;this.hoveredObject!==s&&(this.hoveredObject&&this.hoveredObject.material&&this.hoveredObject.material.color&&!this.hoveredObject.isLine&&(this.hoveredObject.material.color.set("gold"),this.hoveredObject.material.wireframe=!0),this.hoveredObject=s,s.material&&s.material.color&&!this.hoveredObject.isLine&&(this.hoveredObject.originalColor=s.material.color.getHex(),this.hoveredObject.material.color.set("gold"),this.hoveredObject.material.wireframe=!1))}else this.hoveredObject&&(this.hoveredObject.material&&this.hoveredObject.material.color&&!this.hoveredObject.isLine&&(this.hoveredObject.material.color.set(this.hoveredObject.originalColor),this.hoveredObject.material.wireframe=!0),this.hoveredObject=null)}onClick(e){if(e.preventDefault(),this.hoveredObject){this.hoveredObject.material&&this.hoveredObject.material.color;var t=new U;console.log(this.hoveredObject.getWorldPosition(t));var i=this.hoveredObject;this.createModals(i.data),this.imgModal.scale.set(50,50,1),this.imgModal.position.copy(t).multiplyScalar(1.41),this.modal.position.copy(t).multiplyScalar(1.41),this.modal.position.y-=40,this.imgModal.position.y+=45,this.camera.position.copy(t).multiplyScalar(2.4),this.camera.lookAt(0,0,0),this.hoveredObject=null}}}const lS=(n,e)=>{const t=n.__vccOpts||n;for(const[i,s]of e)t[i]=s;return t},cS={data(){return{marsLoaded:!1}},mounted(){const n=this.$el;this.areograph=new aS(n),console.log(this.areograph),this.areograph.start(),this.areograph.on("loadingDone",this.handleLoadingMessage)},methods:{handleLoadingMessage(){this.marsLoaded=!0,console.log(this.marsLoaded)},handleOverlay(){this.areograph.handleOverlay()}}},uS=n=>(lp("data-v-681cff7e"),n=n(),cp(),n),hS={id:"scene-container"},dS={key:0,id:"loading-window"},fS=uS(()=>B("span",null,[B("p",{id:"loading-text"},"Loading assets..."),B("div",{class:"loader"},[B("div",{class:"loaderBar"})])],-1)),pS=[fS],mS={id:"overlay-select-wrapper"};function gS(n,e,t,i,s,r){return wt(),Pt("div",hS,[s.marsLoaded?qt("",!0):(wt(),Pt("div",dS,pS)),B("div",mS,[B("button",{onClick:e[0]||(e[0]=o=>r.handleOverlay())},"Toggle region overlay")])])}const _S=lS(cS,[["render",gS],["__scopeId","data-v-681cff7e"]]),vS=B("header",null,[B("link",{href:"https://fonts.cdnfonts.com/css/overpass",rel:"stylesheet"}),B("link",{href:"https://fonts.googleapis.com/css2?family=Nunito",rel:"stylesheet",type:"text/css"}),B("link",{href:"https://fonts.cdnfonts.com/css/univers",rel:"stylesheet"})],-1),xS={id:"body"},MS={key:0,id:"show-top-bar-hidden"},yS=B("g",{id:"SVGRepo_bgCarrier","stroke-width":"0",transform:"translate(130.35,130.35), scale(0.21)"},[B("path",{transform:"translate(-168.3, -168.3), scale(41.6625)",fill:"#ff0004",d:"M9.166.33a2.25 2.25 0 00-2.332 0l-5.25 3.182A2.25 2.25 0 00.5 5.436v5.128a2.25 2.25 0 001.084 1.924l5.25 3.182a2.25 2.25 0 002.332 0l5.25-3.182a2.25 2.25 0 001.084-1.924V5.436a2.25 2.25 0 00-1.084-1.924L9.166.33z",strokewidth:"0"})],-1),SS=B("g",{id:"SVGRepo_tracerCarrier","stroke-linecap":"round","stroke-linejoin":"round",stroke:"#CCCCCC","stroke-width":"0.66"},null,-1),ES=B("g",{id:"SVGRepo_iconCarrier"},[B("path",{id:"XMLID_224_",d:"M325.606,229.393l-150.004-150C172.79,76.58,168.974,75,164.996,75c-3.979,0-7.794,1.581-10.607,4.394 l-149.996,150c-5.858,5.858-5.858,15.355,0,21.213c5.857,5.857,15.355,5.858,21.213,0l139.39-139.393l139.397,139.393 C307.322,253.536,311.161,255,315,255c3.839,0,7.678-1.464,10.607-4.394C331.464,244.748,331.464,235.251,325.606,229.393z"})],-1),bS=[yS,SS,ES],TS={key:0,id:"top-bar"},wS=B("div",{id:"logo"},[B("div",{id:"logo-mars-bg"},[B("span",{id:"logo-former"},"MARS")]),B("span",{id:"logo-latter"},[st("is a "),B("u",null,"place")])],-1),AS=B("div",{id:"bar-buffer"},null,-1),CS={id:"top-bar-items"},RS=B("span",null,"about",-1),PS=[RS],LS=B("span",null,"filters",-1),DS=[LS],IS=B("span",null,"suggest pin",-1),US=[IS],NS=B("svg",{cursor:"pointer",fill:"rgba(255, 255, 255, 1)",height:"100px",width:"100px",version:"1.1",id:"Layer_2",xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"-168.3 -168.3 666.60 666.60","xml:space":"preserve",stroke:"#ffffff",transform:"rotate(0)matrix(1, 0, 0, 1, 0, 0)","stroke-width":"14.52"},[B("g",{id:"SVGRepo_bgCarrier","stroke-width":"0",transform:"translate(130.35,130.35), scale(0.21)"},[B("path",{transform:"translate(-168.3, -168.3), scale(41.6625)",fill:"#ff0004",d:"M9.166.33a2.25 2.25 0 00-2.332 0l-5.25 3.182A2.25 2.25 0 00.5 5.436v5.128a2.25 2.25 0 001.084 1.924l5.25 3.182a2.25 2.25 0 002.332 0l5.25-3.182a2.25 2.25 0 001.084-1.924V5.436a2.25 2.25 0 00-1.084-1.924L9.166.33z",strokewidth:"0"})]),B("g",{id:"SVGRepo_tracerCarrier","stroke-linecap":"round","stroke-linejoin":"round",stroke:"#CCCCCC","stroke-width":"0.66"}),B("g",{id:"SVGRepo_iconCarrier"},[B("path",{id:"XMLID_224_",d:"M325.606,229.393l-150.004-150C172.79,76.58,168.974,75,164.996,75c-3.979,0-7.794,1.581-10.607,4.394 l-149.996,150c-5.858,5.858-5.858,15.355,0,21.213c5.857,5.857,15.355,5.858,21.213,0l139.39-139.393l139.397,139.393 C307.322,253.536,311.161,255,315,255c3.839,0,7.678-1.464,10.607-4.394C331.464,244.748,331.464,235.251,325.606,229.393z"})])],-1),FS=B("span",null,"hide menu",-1),OS=[NS,FS],BS={key:0,id:"guide-container"},zS={id:"guide-container-items"},HS=B("span",null,"close",-1),kS=[HS],VS=B("span",null,"how it works",-1),GS=[VS],WS=B("span",null,"what is this?",-1),XS=[WS],jS=B("span",null,"FAQ",-1),YS=[jS],qS={key:0,class:"container-under"},KS={key:0,class:"guide-choice"},$S=B("span",{class:"guide-choice-text"},[B("p",null,"Concept")],-1),ZS=B("div",{class:"toggle-content"},[B("span",{class:"what-text"},[B("br"),B("p",null,[st("Over the past 70 years, researchers have clarified our image of Mars into a sparse, cold, and unforgiving place. We're extremely lucky to see it. Our sense of Mars is more concrete now than at any time before. "),B("br"),B("br"),st(" The more we know, the more we might learn about our own planet, the origins of our solar system, and maybe even the prerequisites and potentiates for life. It's a neighbourhood mystery - and our understanding has only recently begun to reflect Mars as it really is. "),B("br"),B("br"),st(" But each discovery also moves us away from the fantastical stories we made up when we knew less - and there is no history for it but in our stories. Mars has no nations, tombs, monuments, wars, legends, or triumphs. It's a blank slate without us. "),B("br"),B("br"),B("i",null,"Mars is a Place"),st(" explores projections of Mars by cataloguing, explaining, and mapping them. Some are old and some are new. Some are contemporaneous to the telling, while others explore our relationship far into the future. Each reveals a part of a long-standing tradition.")])])],-1),QS=B("span",{class:"guide-choice-text"},[B("p",null,"Art")],-1),JS=B("div",{class:"toggle-content"},[B("span",{class:"what-text"},[B("br"),st(" TBD ")])],-1),eE=[$S,ZS,QS,JS],tE={key:1,class:"container-under-how"},nE=B("div",{class:"how-choice"},[B("span",{class:"how-choice-text"}," Map "),B("div",{class:"toggle-content-how"},[B("span",{class:"how-text"},[B("p",null,"Slide the camera plane vertically or horizontally by holding down right click and dragging with left"),B("p",null,"Use your mousewheel or trackpad to scroll in and out (as you would on Google Earth)")])])],-1),iE=B("div",{class:"how-video"},[B("video",{class:"toggle-content-how-video",loop:"",autoplay:""},[B("source",{src:Xm,type:"video/webm"})])],-1),sE=B("div",{class:"how-choice"},[B("span",{class:"how-choice-text"}," Pins "),B("div",{class:"toggle-content-how"},[B("span",{class:"how-text"},[B("p",null,"Click on a pin to see information for an entry - these correspond to individual locations in fiction, film, TV, etc."),B("p",null,"To remove the entry popup, click outside of it or move your camera")])])],-1),rE=B("div",{class:"how-video"},[B("video",{class:"toggle-content-how-video",loop:"",autoplay:""},[B("source",{src:jm,type:"video/webm"})])],-1),oE=B("div",{class:"how-choice"},[B("span",{class:"how-choice-text"}," Overlay "),B("div",{class:"toggle-content-how"},[B("span",{class:"how-text"},[B("p",null,"Toggle the overlay on and off by clicking the button in the bottom left"),B("p",null,"Areas of the overlay correspond to the real regions on Mars' surface")])])],-1),aE=B("div",{class:"how-choice"},[B("span",{class:"how-choice-text"}," Filtering "),B("div",{class:"toggle-content-how"},[B("span",{class:"how-text"},[B("p",null,"The left-hand 'filters' tab contains options for sorting the entries by date, medium, and scope"),B("p",null,"(TBC)")])])],-1),lE=B("div",{class:"how-choice"},[B("div",{class:"toggle-content-how-video"})],-1),cE=[nE,iE,sE,rE,oE,aE,lE],uE={key:2,class:"container-under-FAQ"},hE=B("div",{class:"FAQ-choice"},[B("span",{class:"FAQ-choice-text"},[B("p",null,"Mars")]),B("div",{class:"toggle-content-FAQ"},[B("span",{class:"FAQ-subheading"},[B("p",null,"Is the scene to scale?")]),B("span",{class:"FAQ-text"},[st(" Deimos and Phobos aren't to scale, but Mars' surface is - some unmapped gaps in the terrain were filled with generated textures."),B("br")]),B("span",{class:"FAQ-subheading"},[B("p",null,"How accurate is Mars' surface?")]),B("span",{class:"FAQ-text"}," Mars is depicted in the middle of its northern summer. The planet has a polar tilt of 25°, similar to Earth's 23.5°, which is part of the reason it experiences seasons as well as polar nights/summers. ")])],-1),dE=B("div",{class:"FAQ-choice"},[B("span",{class:"FAQ-choice-text"},[B("p",null,"Attribution")]),B("div",{class:"toggle-content-FAQ"},[B("span",{class:"FAQ-subheading"},[B("p",null,"Where is the background from?")]),B("span",{class:"FAQ-text"},[st(" The starfield is a cubemap built from one of NASA's "),B("a",{class:"link-highlight",href:"https://svs.gsfc.nasa.gov/4851/"},"Deep Star Maps"),st(", itself assembled from a few different star catalogs. ")]),B("span",{class:"FAQ-subheading"},[B("p",null,"Mars?")]),B("span",{class:"FAQ-text"},[st(" Mars' texture was created from NASA surface imagery (and released for free!) by the team at "),B("a",{class:"link-highlight",href:"https://www.solarsystemscope.com/textures/"},"Solar System Scope"),st(". I turned this into another cubemap and projected it onto a quadrilateralized spherical cube (quad sphere). I also generated my displacement, ambient occlusion, and normal maps from it. ")]),B("span",{class:"FAQ-subheading"},[B("p",null,"Phobos & Deimos?")]),B("span",{class:"FAQ-text"},[st(" The Deimos and Phobos models were proposed and created by Ernst, Daly, and Gaskell et al. in their extremely helpful "),B("a",{class:"link-highlight",href:"https://earth-planets-space.springeropen.com/articles/10.1186/s40623-023-01814-7"},"2023 paper"),st(" - you can download the models directly from their Small Body Mapping Tool/SBMT site "),B("a",{class:"link-highlight",href:"https://sbmt.jhuapl.edu/Object-Index.php"},"here"),st(" (.OBJ with 4 spatial resolution options). ")]),B("span",{class:"FAQ-subheading"},[B("p",null,"Region overlay?")]),B("span",{class:"FAQ-text"},[st(" The region overlay is adapted (with permission) from a "),B("a",{class:"link-highlight",href:"https://www.deviantart.com/etohautakuva/art/Mars-Geographic-Regions-Map-v0-1-917110370"},"map by the artist Etohautakuva."),st(" They compiled data from the USGS/NASA to create an approximation of Martian regional boundaries as recognised by the International Astronomical Union (IAU). ")])])],-1),fE=B("div",{class:"FAQ-choice"},[B("span",{class:"FAQ-choice-text"},[B("p",null,"Developer")]),B("div",{class:"toggle-content-FAQ"},[B("span",{class:"FAQ-subheading"},[B("p",null,"Tech stack?")]),B("span",{class:"FAQ-text"},[st(" Three.js for rendering and animating the scene and Vue 3 for the overlay inc. SPA functionality and general reactivity. Pin data are stored in rudimentary arrays of objects for now; this will change to SQLite in future."),B("br")]),B("span",{class:"FAQ-subheading"},[B("p",null,"I found a bug - what can I do?")]),B("span",{class:"FAQ-text"}," This is a WIP, so feel free to create a new issue or pull request on the repo. You can also contact me at xxx with what happened. ")])],-1),pE=[hE,dE,fE],mE={key:0,id:"guide-container"},gE=B("div",{class:"container-under"},[B("span",null,"TBD ")],-1),_E=[gE],vE={key:0,id:"suggest-container"},xE={id:"suggest-container-items"},ME=B("span",null,"close",-1),yE=[ME],SE={id:"container-under-suggest"},EE={id:"suggest-form",action:"",method:"POST"},bE={key:0,id:"email-disclaimer"},TE=B("span",null,"I'll only email you if I have question about your idea for a pin. I do not retain addresses and will never spam you.",-1),wE=[TE],AE={class:"container-input-smaller"},CE=B("label",{class:"suggest-label"},"Submissions disabled for now.",-1),RE=B("br",null,null,-1),PE=B("br",null,null,-1),LE={class:"suggest-label"},DE={class:"suggest-hint"},IE=B("input",{disabled:"",class:"suggest-input-smaller",type:"email",name:"email"},null,-1),UE=B("div",{class:"container-input-smaller"},[B("label",{class:"suggest-label"},[st(" Submission Name "),B("textarea",{disabled:"",class:"suggest-input-smaller",name:"message"})])],-1),NE=B("div",{class:"container-input-smaller"},[B("label",{class:"suggest-label"},[st(" Author "),B("textarea",{disabled:"",class:"suggest-input-smaller",name:"message"})])],-1),FE=B("div",{class:"container-input-smaller"},[B("label",{class:"suggest-label"},[st(" Year "),B("textarea",{disabled:"",class:"suggest-input-smaller",name:"message"})])],-1),OE=B("div",{class:"container-input-smaller"},[B("label",{class:"suggest-label"},[st(" Fictional Year "),B("p",{class:"suggest-hint"},"optional, provide if this applies"),B("textarea",{disabled:"",class:"suggest-input-smaller",name:"message"})])],-1),BE=B("div",{class:"container-input-smaller"},[B("label",{class:"suggest-label"},[st(" Lat/Lon "),B("p",{class:"suggest-hint"},"optional, helpful if you have them"),B("textarea",{disabled:"",class:"suggest-input-smaller",name:"message"})])],-1),zE=B("div",{class:"container-input-larger"},[B("label",{class:"suggest-label"},[st(" Description "),B("textarea",{disabled:"",class:"suggest-input-larger",name:"message"})])],-1),HE=B("button",{disabled:"",id:"suggest-input-button",type:"submit"},"Send",-1),kE={key:0,id:"about-container"},VE=B("div",{class:"container-under"},[B("span",null,"Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa nihil dolore similique quis qui ad blanditiis ex eum! Enim maiores ipsam fugiat officiis earum distinctio natus reprehenderit aliquam est iusto! ")],-1),GE=[VE],WE={data(){return{navBar:!0,guide:!1,about:!1,suggest:!1,tabShown:null,guideHow:!0,guideWhat:!1,guideFAQ:!1,isLoading:!0,loadingHistory:[],showEmailDisclaimer:!1}},methods:{handleLoadingBar(n){},handleNavBar(n){switch(n){case"show":this.navBar=!0;break;case"hide":this.navBar=!1;break}},handleModals(n){switch(n){case"guide":this.about=!1,this.suggest=!1,this.guide=!0,document.documentElement.style.setProperty("--guide-background-color","rgba(255, 0, 0, 0.7"),document.documentElement.style.setProperty("--guide-font-weight",100),document.documentElement.style.setProperty("--guide-font-size","17px"),document.documentElement.style.setProperty("--about-background-color","rgba(255, 255, 255, 0.2"),document.documentElement.style.setProperty("--about-font-weight",400),document.documentElement.style.setProperty("--about-font-size","18px"),document.documentElement.style.setProperty("--suggest-background-color","rgba(255, 255, 255, 0.2"),document.documentElement.style.setProperty("--suggest-font-weight",400),document.documentElement.style.setProperty("--suggest-font-size","18px");break;case"about":this.guide=!1,this.suggest=!1,this.about=!0,document.documentElement.style.setProperty("--about-background-color","rgba(255, 0, 0, 0.7"),document.documentElement.style.setProperty("--about-font-weight",100),document.documentElement.style.setProperty("--about-font-size","17px"),document.documentElement.style.setProperty("--guide-background-color","rgba(255, 255, 255, 0.2"),document.documentElement.style.setProperty("--guide-font-weight",400),document.documentElement.style.setProperty("--guide-font-size","18px"),document.documentElement.style.setProperty("--suggest-background-color","rgba(255, 255, 255, 0.2"),document.documentElement.style.setProperty("--suggest-font-weight",400),document.documentElement.style.setProperty("--suggest-font-size","18px");break;case"suggest":this.guide=!1,this.about=!1,this.suggest=!0,document.documentElement.style.setProperty("--suggest-background-color","rgba(255, 0, 0, 0.7"),document.documentElement.style.setProperty("--suggest-font-weight",100),document.documentElement.style.setProperty("--suggest-font-size","17px"),document.documentElement.style.setProperty("--guide-background-color","rgba(255, 255, 255, 0.2"),document.documentElement.style.setProperty("--guide-font-weight",400),document.documentElement.style.setProperty("--guide-font-size","18px"),document.documentElement.style.setProperty("--about-background-color","rgba(255, 255, 255, 0.2"),document.documentElement.style.setProperty("--about-font-weight",400),document.documentElement.style.setProperty("--about-font-size","18px");break;default:this.guide=!1,this.about=!1,this.suggest=!1,document.documentElement.style.setProperty("--guide-background-color","rgba(255, 255, 255, 0.2"),document.documentElement.style.setProperty("--guide-font-weight",400),document.documentElement.style.setProperty("--guide-font-size","18px"),document.documentElement.style.setProperty("--about-background-color","rgba(255, 255, 255, 0.2"),document.documentElement.style.setProperty("--about-font-weight",400),document.documentElement.style.setProperty("--about-font-size","18px"),document.documentElement.style.setProperty("--suggest-background-color","rgba(255, 255, 255, 0.2"),document.documentElement.style.setProperty("--suggest-font-weight",400),document.documentElement.style.setProperty("--suggest-font-size","18px");break}},handleGuideTabs(n){switch(n){case"what":this.guideHow=!1,this.guideFAQ=!1,this.guideWhat=!0,document.documentElement.style.setProperty("--guideWhat-background-color","rgba(255, 255, 255, 1)"),document.documentElement.style.setProperty("--guideWhat-color","rgba(255, 255, 255, 1)"),document.documentElement.style.setProperty("--guideWhat-font-weight",100),document.documentElement.style.setProperty("--guideWhat-font-size","32px"),document.documentElement.style.setProperty("--guideWhat-shadow","1px 0 0 #000, 0 -1px 0 #000, 0 1px 0 #000, -1px 0 0 #000"),document.documentElement.style.setProperty("--guideHow-background-color","rgba(255, 255, 255, 0.5)"),document.documentElement.style.setProperty("--guideHow-color","rgba(0, 0, 0, 1)"),document.documentElement.style.setProperty("--guideHow-font-weight",200),document.documentElement.style.setProperty("--guideHow-font-size","34px"),document.documentElement.style.setProperty("--guideHow-shadow","none"),document.documentElement.style.setProperty("--guideFAQ-background-color","rgba(255, 255, 255, 0.5)"),document.documentElement.style.setProperty("--guideFAQ-color","rgba(0, 0, 0, 1)"),document.documentElement.style.setProperty("--guideFAQ-font-weight",200),document.documentElement.style.setProperty("--guideFAQ-font-size","34px"),document.documentElement.style.setProperty("--guideFAQ-shadow","none");break;case"how":this.guideWhat=!1,this.guideFAQ=!1,this.guideHow=!0,document.documentElement.style.setProperty("--guideHow-background-color","rgba(255, 255, 255, 1)"),document.documentElement.style.setProperty("--guideHow-color","rgba(255, 255, 255, 1)"),document.documentElement.style.setProperty("--guideHow-font-weight",100),document.documentElement.style.setProperty("--guideHow-font-size","32px"),document.documentElement.style.setProperty("--guideHow-shadow","1px 0 0 #000, 0 -1px 0 #000, 0 1px 0 #000, -1px 0 0 #000"),document.documentElement.style.setProperty("--guideWhat-background-color","rgba(255, 255, 255, 0.5)"),document.documentElement.style.setProperty("--guideWhat-color","rgba(0, 0, 0, 1)"),document.documentElement.style.setProperty("--guideWhat-font-weight",200),document.documentElement.style.setProperty("--guideWhat-font-size","34px"),document.documentElement.style.setProperty("--guideWhat-shadow","none"),document.documentElement.style.setProperty("--guideFAQ-background-color","rgba(255, 255, 255, 0.5)"),document.documentElement.style.setProperty("--guideFAQ-color","rgba(0, 0, 0, 1)"),document.documentElement.style.setProperty("--guideFAQ-font-weight",200),document.documentElement.style.setProperty("--guideFAQ-font-size","34px"),document.documentElement.style.setProperty("--guideFAQ-shadow","none");break;case"questions":this.guideWhat=!1,this.guideHow=!1,this.guideFAQ=!0,document.documentElement.style.setProperty("--guideFAQ-background-color","rgba(255, 255, 255, 1)"),document.documentElement.style.setProperty("--guideFAQ-color","rgba(255, 255, 255, 1)"),document.documentElement.style.setProperty("--guideFAQ-font-weight",100),document.documentElement.style.setProperty("--guideFAQ-font-size","32px"),document.documentElement.style.setProperty("--guideFAQ-shadow","1px 0 0 #000, 0 -1px 0 #000, 0 1px 0 #000, -1px 0 0 #000"),document.documentElement.style.setProperty("--guideWhat-background-color","rgba(255, 255, 255, 0.5)"),document.documentElement.style.setProperty("--guideWhat-color","rgba(0, 0, 0, 1)"),document.documentElement.style.setProperty("--guideWhat-font-weight",200),document.documentElement.style.setProperty("--guideWhat-font-size","34px"),document.documentElement.style.setProperty("--guideWhat-shadow","none"),document.documentElement.style.setProperty("--guideHow-background-color","rgba(255, 255, 255, 0.5)"),document.documentElement.style.setProperty("--guideHow-color","rgba(0, 0, 0, 1)"),document.documentElement.style.setProperty("--guideHow-font-weight",200),document.documentElement.style.setProperty("--guideHow-font-size","34px"),document.documentElement.style.setProperty("--guideHow-shadow","none");break}}}},XE=Object.assign(WE,{__name:"App",setup(n){return(e,t)=>(wt(),Pt(pn,null,[vS,B("div",xS,[dt(Fn,{duration:550,name:"nested"},{default:ti(()=>[e.navBar?qt("",!0):(wt(),Pt("div",MS,[(wt(),Pt("svg",{cursor:"pointer",onClick:t[0]||(t[0]=i=>e.handleNavBar("show")),fill:"rgba(255, 255, 255, 0.9)",height:"100px",width:"100px",version:"1.1",id:"Layer_1",xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"-168.3 -168.3 666.60 666.60","xml:space":"preserve",stroke:"#ffffff",transform:"rotate(180)matrix(1, 0, 0, 1, 0, 0)","stroke-width":"14.52"},bS))]))]),_:1}),dt(Fn,{duration:550,name:"nested"},{default:ti(()=>[e.navBar?(wt(),Pt("div",TS,[wS,AS,B("div",CS,[B("div",{onClick:t[1]||(t[1]=i=>e.handleModals("guide")),id:"bar-guide"},PS),B("div",{onClick:t[2]||(t[2]=i=>e.handleModals("about")),id:"bar-about"},DS),B("div",{onClick:t[3]||(t[3]=i=>e.handleModals("suggest")),id:"bar-suggest"},US),e.navBar?(wt(),Pt("div",{key:0,id:"show-top",onClick:t[4]||(t[4]=i=>{e.handleNavBar("hide"),e.handleModals()})},OS)):qt("",!0)])])):qt("",!0)]),_:1}),dt(Fn,{duration:550,name:"nested"},{default:ti(()=>[e.guide?(wt(),Pt("div",BS,[B("div",zS,[B("div",{onClick:t[5]||(t[5]=i=>e.handleModals()),class:"container-close"},kS),B("div",{onClick:t[6]||(t[6]=i=>e.handleGuideTabs("how")),class:"container-item"},GS),B("div",{onClick:t[7]||(t[7]=i=>e.handleGuideTabs("what")),class:"container-item"},XS),B("div",{onClick:t[8]||(t[8]=i=>e.handleGuideTabs("questions")),class:"container-item"},YS)]),e.guideWhat?(wt(),Pt("div",qS,[e.chosenRead?qt("",!0):(wt(),Pt("div",KS,eE))])):qt("",!0),e.guideHow?(wt(),Pt("div",tE,cE)):qt("",!0),e.guideFAQ?(wt(),Pt("div",uE,pE)):qt("",!0)])):qt("",!0)]),_:1}),dt(Fn,{duration:550,name:"nested"},{default:ti(()=>[e.about?(wt(),Pt("div",mE,_E)):qt("",!0)]),_:1}),dt(Fn,{duration:550,name:"nested"},{default:ti(()=>[e.suggest?(wt(),Pt("div",vE,[B("div",xE,[B("div",{onClick:t[9]||(t[9]=i=>e.handleModals()),class:"container-close"},yE)]),B("div",SE,[B("form",EE,[dt(Fn,{duration:"550",name:"email-disclaimer-transition"},{default:ti(()=>[e.showEmailDisclaimer?(wt(),Pt("div",bE,wE)):qt("",!0)]),_:1}),B("div",AE,[CE,RE,PE,B("label",LE,[st(" Email "),B("span",DE,[st(" optional "),B("p",{class:"disclaimer-label",onTouchstart:t[10]||(t[10]=i=>e.showEmailDisclaimer=!0),onTouchend:t[11]||(t[11]=i=>e.showEmailDisclaimer=!1),onMouseover:t[12]||(t[12]=i=>e.showEmailDisclaimer=!0),onMouseleave:t[13]||(t[13]=i=>e.showEmailDisclaimer=!1)},"(why do I ask for this?)",32)]),IE])]),UE,NE,FE,OE,BE,zE,HE])])])):qt("",!0)]),_:1}),dt(Fn,{duration:550,name:"nested"},{default:ti(()=>[e.tabShown=="what"?(wt(),Pt("div",kE,GE)):qt("",!0)]),_:1}),dt(_S,{onClick:t[14]||(t[14]=i=>e.handleModals())})])],64))}}),jE=Vm(XE);jE.mount("#app");
